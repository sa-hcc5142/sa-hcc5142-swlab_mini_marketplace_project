...
class AdminControllerIT {
    ...
    /**
     * Test Case 1: GET /api/admin/users - Admin Access
    ...
    void testGetAllUsers_AdminAccess_Success() throws Exception {
        mockMvc.perform(get("/api/admin/users")
                ...
                .andExpect(jsonPath("$[*].username", hasItems("admin_test_user", "seller_test_user", "buyer_test_user")));
    }

    /**
     * Test Case 2: GET /api/admin/users/{id} - Admin Access
    ...
    void testGetUserById_AdminAccess_Success() throws Exception {
        mockMvc.perform(get("/api/admin/users/" + sellerUser.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", equalTo(sellerUser.getId().intValue())))
                .andExpect(jsonPath("$.username", equalTo("seller_test_user")))
                .andExpect(jsonPath("$.email", equalTo("seller_test@marketplace.local")));
    }

    /**
     * Test Case 3: PUT /api/admin/users/{id}/role - Admin Updates Role
    ...
    /**
     * Test Case 4: PUT /api/admin/users/{id}/deactivate - Admin Deactivates User
    ...
    void testDeactivateUser_AdminAccess_Success() throws Exception {
        mockMvc.perform(put("/api/admin/users/" + buyerUser.getId() + "/deactivate")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", equalTo(buyerUser.getId().intValue())))
                .andExpect(jsonPath("$.active", equalTo(false)));
    }

    /**
     * Test Case 5: GET /api/admin/users - Seller Access Denied (403)
    ...
    /**
     * Test Case 6: PUT /api/admin/users/{id}/role - Buyer Access Denied (403)
    ...
    /**
     * Test Case 7: GET /api/admin/users - Unauthenticated Access Denied (401)
